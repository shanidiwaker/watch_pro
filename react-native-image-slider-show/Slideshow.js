        ...
        {/* <View
          ...
          {this.props.dataSource.map((image, index) => {
            return (
              ...
              >
                <View><Text style={{color: '#fff'}}>{position}</Text></View>
              </TouchableOpacity>);
          })}
        </View> */}
        <View
          ...
          <TouchableOpacity>
            <View style={{backgroundColor: '#E7E7EF', padding: 2, paddingHorizontal: 10, borderRadius: 45}}>
              <Text style={{color: '#000',fontFamily:'ProximaNova-Regular'}}>{position + 1} / {this.props.dataSource.length}</Text>
            </View>
          </TouchableOpacity>
